...
function Ex04() {
  ...
  return (
    <div style={{ padding: "20px", border: "1px solid #ccc" }}>
      ...
      <div>
        <input type="text" onChange={handleIn1} placeholder={in1} value={in1} /> +{" "}
        <input type="text" onChange={handleIn2} placeholder={in2} value={in2} /> ={" "}
        {in1 * 1 + in2 * 1}
      </div>
      <div>
        <input type="text" onChange={handleIn1} placeholder={in1} value={in1} /> -{" "}
      ...
      <div>
        <input type="text" onChange={handleIn1} placeholder={in1} value={in1} /> x{" "}
        <input type="text" onChange={handleIn2} placeholder={in2} value={in2} /> ={" "}
        {in1 * 1  * in2 * 1}
      </div>
      <div>
